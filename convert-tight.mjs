...
const inDir = path.join(__dirname, 'public', 'tight');
const outDir = path.join(__dirname, 'public', 'tight-webp');
...
async function convertImages() {
  try {
    ...
    for (const file of files) {
      ...
      console.log(`✓ Converted to WebP: ${filenameBase}.webp`);
    }
    
    console.log(`\nSuccess! All tight images converted to WebP.`);
  } catch (err) {
