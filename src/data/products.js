export const productsData = [
  {
    ...
    variants: [
      { name: "1/2\" (Burbuja Grande)", width: 1.22, length: 125, unit: "m" },
      { name: "3/16\" (Burbuja Chica)", width: 1.22, length: 65, unit: "m" }
    ],
    whatsappMsg: "Me interesa cotizar Poliburbuja estándar de 1/2 o 3/16.",
    seo: {
      title: "Fábrica de Poliburbuja Industrial 1/2 y 3/16 | GACE",
      description: "Proveedor directo de Poliburbuja industrial. Rollos de 1.22m de altura en calibres 1/2\" y 3/16\". Fabricación GACE con calidad de mercado."
    }
  },
  {
    id: "poliburbuja-corte",
    ...
    benefits: [
      ...
      "Fácil manejo en líneas de empaque"
    ],
    variants: [
      { name: "Corte 30 cm", width: 0.30, length: "65/125", unit: "m" },
      { name: "Corte 40 cm", width: 0.40, length: "65/125", unit: "m" },
      { name: "Corte 60 cm", width: 0.60, length: "65/125", unit: "m" }
    ],
  ...
  {
    id: "poliburbuja-punteada",
    slug: "poliburbuja-punteada",
    ...
    benefits: [
      "Corte manual sin herramientas",
      "Ahorro de tiempo en embalaje"
    ],
    variants: [
      { name: "Rango 30-100 cm", width: 1.22, length: "65/125", unit: "m" }
    ],
    whatsappMsg: "Cotización para Poliburbuja Punteada (30 a 100 cm).",
    seo: {
      title: "Poliburbuja Punteada por Mayoreo 30cm-100cm | GACE",
      description: "Poliburbuja punteada con rangos de 30 hasta 100 cms. Calibres 1/2 y 3/16. Ideal para optimizar embalaje industrial."
    }
  },
  {
    id: "mini-poliburbuja",
    ...
    features: [
      ...
      "60 cms con 5 o 10 mts",
      "Poliburbuja 1/2\" y 3/16\""
    ],
    benefits: [
      "Ideal para envíos pequeños",
      "Fácil almacenamiento"
    ],
    variants: [
      { name: "Ancho 30 cm", length: "5 o 10m", unit: "" },
      { name: "Ancho 40 cm", length: "5 o 10m", unit: "" },
      { name: "Ancho 60 cm", length: "5 o 10m", unit: "" }
    ],
    whatsappMsg: "Me interesa la Mini Poliburbuja de 5 o 10 metros.",
    seo: {
      title: "Mini Poliburbuja para Negocio 5m y 10m | GACE",
      description: "Mini rollos de poliburbuja para retail y oficina. Disponibles en 5 y 10 metros de largo. Anchos de 30, 40 y 60 cms."
    }
  },
  {
    id: "malla-normal",
    slug: "malla-plastica-normal",
  ...
  {
    id: "malla-navidad",
    slug: "malla-para-arbol-navideño",
